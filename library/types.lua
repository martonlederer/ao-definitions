...
-- Message generated by ao.send() or ao.spawn()
---@class OutgoingMessage
---@field Target string Target to send the message to
---@field Data string? Message transaction data
---@field Tags Tag[]
---@field onReply fun(resolver: HandlerFunction) Handler to execute on replying
---@field receive fun(from?: string): Message Pause execution using Lua coroutines and return the response message
